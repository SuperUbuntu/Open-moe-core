...
> Mcore 的现代化 Web 管理面板 - 基于 React 19 + TypeScript + Vite 构建
...
Mcore Dashboard 是 Mcore 聊天智能体的 Web 管理界面，提供了直观的配置管理、实时监控、插件管理、资源管理等功能。通过自动解析后端配置类，动态生成表单，实现了配置的可视化编辑。

<div align="center">
  <img src="docs/main.png" alt="Mcore Dashboard 界面预览" width="800" />
</div>
...
构建产物会输出到 `dist/` 目录，由 Mcore 后端静态服务。
