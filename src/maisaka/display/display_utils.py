...
_REQUEST_PANEL_STYLE_MAP: dict[str, tuple[str, str]] = {
    "planner": ("Moe Core 大模型请求 - 对话单步", "green"),
    "timing_gate": ("Moe Core 大模型请求 - Timing Gate 子代理", "bright_magenta"),
    "replyer": ("Moe Core 回复器 Prompt", "bright_yellow"),
    "emotion": ("Moe Core Emotion Tool Prompt", "bright_cyan"),
    "sub_agent": ("Moe Core 大模型请求 - 子代理", "bright_blue"),
}
